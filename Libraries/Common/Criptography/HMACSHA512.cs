...
namespace Myframework.Libraries.Common.Criptography
{
    ...
    /// </summary>
    public class HMACSHA512 : CriptographyBase
    {
        /// <summary>
        ...
        public string HashWithSalt(string value, byte[] salt, int hashByteSize, int iterations = 11001) => (Convert.ToBase64String(KeyDerivation.Pbkdf2(value, salt, KeyDerivationPrf.HMACSHA512, iterations, hashByteSize)));
